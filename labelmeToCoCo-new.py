...
class Lableme2CoCo:
    ...
    def _annotation(self, shape):
        ...
        # 由于只识别yolk类,所以是：category_id是1 (因为labelme对于同一类的)
        annotation['category_id'] = classname_to_id['yolk']
        # annotation['category_id'] = int(classname_to_id[label])  # classname_to_id字典保存类所代表的id
